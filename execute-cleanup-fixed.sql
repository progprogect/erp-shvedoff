-- ЭТАП 4: ВЫПОЛНЕНИЕ ОЧИСТКИ БД ERP SHVEDOFF (ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
-- ЛОГИРОВАНИЕ НАЧАЛА ОЧИСТКИ (исправленные колонки)
INSERT INTO audit_log (user_id, operation, table_name, record_id, created_at)
VALUES (1, 'CLEANUP_START', 'SYSTEM', 0, NOW());
...
INSERT INTO audit_log (user_id, operation, table_name, record_id, created_at)
VALUES (1, 'CLEANUP_SUCCESS', 'SYSTEM', 0, NOW());
