              ...
              <Card title="📋 Информация о товаре">
                ...
                >
                  ...
                  {(product?.productType === 'carpet' || product?.productType === 'roll_covering') && (
                    <>
                      {/* 🔥 ИСПРАВЛЕНИЕ: Убираем дублирование - низ ковра отображается только в специальном блоке для ковров */}
              ...
              <div style={{ maxWidth: '600px' }}>
                {product.rollComposition.map((item, index) => (
                  <div key={index} style={{ 
                    ...
                    marginBottom: index < (product.rollComposition?.length || 0) - 1 ? 12 : 0,
                    padding: '12px 16px',
