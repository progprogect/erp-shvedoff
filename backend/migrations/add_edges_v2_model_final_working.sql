-- Миграция: Расширение модели товара с поддержкой краёв и бортов (edges_v2) - ФИНАЛЬНАЯ РАБОЧАЯ
-- Дата: 2025-08-18
